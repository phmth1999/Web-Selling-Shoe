				...
				<div class="col-lg-9 order-1 order-lg-2">
					<div class="row">
						<div class="col-lg-6 col-sm-6">
							<div class="blog-item">
								<div class="bi-pic">
									<img src="template/user/img/blog/blog-1.jpg" alt="">
								</div>
								<div class="bi-text">
						...
						<div class="col-lg-6 col-sm-6">
							<div class="blog-item">
								<div class="bi-pic">
									<img src="template/user/img/blog/blog-2.jpg" alt="">
								</div>
								<div class="bi-text">
									<a href='<c:url value="/blog-detail" />'>
						...
						<div class="col-lg-6 col-sm-6">
							<div class="blog-item">
								<div class="bi-pic">
									<img src="template/user/img/blog/blog-3.jpg" alt="">
								</div>
								<div class="bi-text">
									<a href='<c:url value="/blog-detail" />'>
						...
						<div class="col-lg-6 col-sm-6">
							<div class="blog-item">
								<div class="bi-pic">
									<img src="template/user/img/blog/blog-4.jpg" alt="">
								</div>
								<div class="bi-text">
									<a href='<c:url value="/blog-detail" />'>
						...
						<div class="col-lg-6 col-sm-6">
							<div class="blog-item">
								<div class="bi-pic">
									<img src="template/user/img/blog/blog-5.jpg" alt="">
								</div>
								<div class="bi-text">
									<a href='<c:url value="/blog-detail" />'>
						...
						<div class="col-lg-6 col-sm-6">
							<div class="blog-item">
								<div class="bi-pic">
									<img src="template/user/img/blog/blog-6.jpg" alt="">
								</div>
								<div class="bi-text">
									<a href='<c:url value="/blog-detail" />'>
